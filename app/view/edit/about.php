	...
	<header>
		...
		<nav>
			<div id="mainmenus">
				...
				<a href="<?= URLROOT ?>/edit/about" class="active">about</a>
				<a href="<?= URLROOT ?>/edit/logout" class="logout"><i class="fas fa-sign-out-alt"></i> logout</a>
			</div>
		</nav>
	</header>
	<main id="about-edit">
		<p contenteditable="true" id="bioHolder" title="Click to edit" class="preview"><?= nl2br($data["bio"]->body); ?></p>
		<button id="saveBtn"><i class="far fa-save"></i> save</button>
	</main>
	
	<script src="<?= URLROOT ?>/js/edit_about.js?<?= TIMESTAMP ?>"></script>
</body>
</html>